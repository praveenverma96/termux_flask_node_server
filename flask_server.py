...
try:
    ...
    import subprocess
    import sys,os
    os.system('python -m pip install qrcode-terminal')
    #can use the below methodas well
    # subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'qrcode-terminal'])
    import qrcode_terminal
...
if __name__ == '__main__':
    ...
    print(f"Flask server running at {url}")
